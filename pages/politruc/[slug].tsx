            ...
            <div className='bg-white overflow-hidden'>
              <div className='relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8'>
                ...
                <div className='mx-auto text-base max-w-prose lg:max-w-none'>
                  <h2 className='text-base text-red-600 font-semibold tracking-wide uppercase'>{candidate.party}</h2>
                ...
                <div className='mt-8 lg:grid lg:grid-cols-2 lg:gap-8'>
                  ...
                  <div className='mt-8 lg:mt-0'>
                    <div className='text-base max-w-prose mx-auto lg:max-w-none'>
                      <strong className='text-lg text-gray-500'>{candidate.review}</strong>
                    </div>
                    <div className='mt-5 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1'>
                      {documentToReactComponents(candidate.content.json, options)}
                    </div>
                  </div>
                </div>
              </div>
